      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="text-sm leading-6 text-gray-600">
              En yeni teknoloji ürünleri uygun fiyatlarla kapınızda.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold leading-6 text-gray-900">Kategoriler</h3>
                <ul role="list" className="mt-6 space-y-4">
                  {categories.map((category: any) => (
                    <li key={category._id}>
                      <Link href={`/categories/${category._id}`} className="text-sm leading-6 text-gray-600 hover:text-gray-900">
                        {category.name}
                      </Link>
                    </li>
                  ))}
              ...
              <div className="mt-10 md:mt-0">
                ...
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li>
                    <Link href="/shipping" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
                      Kargo ve Teslimat
                    </Link>
                  </li>
                  <li>
                    <Link href="/returns" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
                      İade ve Değişim
                    </Link>
                  </li>
                  <li>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul role="list" className="mt-6 space-y-4">
                  ...
                  <li>
                    <Link href="/press" className="text-sm leading-6 text-gray-600 hover:text-gray-900">
                      Basın
                    </Link>
                  </li>
                </ul>
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
          <p className="text-xs leading-5 text-gray-500">
            &copy; {new Date().getFullYear()} ShopNext. Tüm hakları saklıdır.
          </p>
        </div>
      </div>
    </footer>
